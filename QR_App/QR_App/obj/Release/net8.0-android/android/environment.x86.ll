...
@dso_cache = dso_local local_unnamed_addr global [532 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 454057754, ; hash 0x1b105f1a, from name: aot-QR_App.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1841000753, ; hash 0x6dbb7131, from name: QR_App
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-QR_App.dll.so
		ptr null; void* handle (0x0)
	}, ; 216
	...
	%struct.DSOCacheEntry {
		i64 3099528759, ; hash 0xb8bf0e37, from name: libaot-QR_App
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-QR_App.dll.so
		ptr null; void* handle (0x0)
	}, ; 394
	...
	%struct.DSOCacheEntry {
		i64 4027432161, ; hash 0xf00dbce1, from name: aot-QR_App
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-QR_App.dll.so
		ptr null; void* handle (0x0)
	}, ; 500
	...
	%struct.DSOCacheEntry {
		i64 4051454899, ; hash 0xf17c4bb3, from name: QR_App.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-QR_App.dll.so
		ptr null; void* handle (0x0)
	}, ; 503
	...
	%struct.DSOCacheEntry {
		i64 4228784080, ; hash 0xfc0e1fd0, from name: libaot-QR_App.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-QR_App.dll.so
		ptr null; void* handle (0x0)
	}, ; 525
